...
export async function getSystemModulesAction() {
  try {
    ...
    const defaultModules = [
      ...
      { code: "gift_cards", name: "Vales-Presente & Gift Cards Digitais", description: "Venda e gerencie vales-presente digitais com saldo fracionável.", icon: "Gift", monthlyPrice: 39.9, lifetimePrice: 249.0, billingType: "BOTH", category: "GROWTH" },
