...
export async function getSystemModulesAction() {
  ...
  try {
    ...
    const defaultModules = [
      ...
      { code: "cofre_do_cliente", name: "Cofre do Cliente (Antes/Depois & Ficha Técnica)", description: "Galeria privada por cliente e ficha técnica do que foi feito — fórmula, oxidante, lâmina — com sugestão do histórico do profissional.", icon: "Lock", monthlyPrice: 49.9, lifetimePrice: 0.0, billingType: "SUBSCRIPTION", category: "OPERATIONS" },
