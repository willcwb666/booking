      ...
      <div className="bg-white rounded-3xl border border-slate-200/80 p-6 sm:p-8 space-y-6 shadow-xs">
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base font-extrabold text-slate-900">Solicitar Reset de Presets</h2>
          ...
          {presetResetFee > 0 && (
            <div className="p-3 bg-indigo-50/80 border border-indigo-200/80 rounded-2xl text-right">
              <span className="text-[10px] text-indigo-600 font-bold uppercase tracking-wider block">Taxa Oficial</span>
              <span className="text-sm font-extrabold text-indigo-900">R$ {presetResetFee.toFixed(2)}</span>
            </div>
          )}
        </div>
        ...
        <div className="space-y-4 text-xs text-slate-600 leading-relaxed border-t border-slate-100 pt-4">
          ...
          <div className="p-4 bg-slate-50/80 border border-slate-200/80 rounded-2xl space-y-2.5">
            ...
            <ul className="space-y-1.5 text-slate-600 pl-6">
              ...
              <li className="flex items-start gap-2">
                <DollarSign className="w-3.5 h-3.5 text-indigo-600 shrink-0 mt-0.5" />
        ...
        {canEdit && (
          <div className="pt-2 flex justify-start">
            <button
              ...
              className="px-6 py-3 bg-[#635bff] hover:bg-[#544dc9] text-white font-semibold text-xs rounded-xl shadow-xs transition-all cursor-pointer flex items-center gap-2"
            >
