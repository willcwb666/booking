      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-[var(--color-bg)] p-6 sm:p-8 rounded-[var(--radius-panel)] border border-[var(--color-border)] shadow-xs relative overflow-hidden">
        <div className="space-y-1 z-10">
          <div className="flex items-center gap-2 text-[var(--color-primary)] font-semibold text-xs uppercase tracking-wider">
            <Package className="w-4 h-4 text-[var(--color-success)] animate-pulse" />
        ...
        <div className="flex items-center gap-2.5 shrink-0 z-10">
          <Link
            ...
            className="px-4 py-2.5 bg-[var(--color-bg-muted)] hover:bg-[var(--color-bg-muted)] text-[var(--color-text)] rounded-[var(--radius-control)] transition-all font-semibold text-xs inline-flex items-center justify-center gap-2 cursor-pointer border border-[var(--color-border)]"
          >
      ...
      <div className="bg-[var(--color-bg)] rounded-[var(--radius-panel)] border border-[var(--color-border)] p-4 sm:p-5 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-xs">
        <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto flex-1">
          ...
          <button
            ...
            className={`px-3 py-2 text-xs font-bold rounded-[var(--radius-control)] border transition-colors cursor-pointer inline-flex items-center gap-1.5 ${
              currentLowStockOnly
                ? "bg-[var(--color-warning)] text-white border-[var(--color-warning-border)] shadow-xs"
                : "bg-[var(--color-bg-subtle)] text-[var(--color-text-muted)] border-[var(--color-border)] hover:bg-[var(--color-bg-muted)]"
            }`}
          >
                ...
                productsResult.items.map((p) => (
                  <tr key={p.id} className="hover:bg-[var(--color-bg-subtle)]/40 transition-colors">
                    <td className="py-3.5 px-4">
                      <p className="font-semibold text-[var(--color-text-heading)]">{p.name}</p>
                      <div className="flex items-center gap-2 mt-0.5 text-[var(--text-2xs)] text-[var(--color-text-subtle)]">
                        {p.category && (
                    ...
                    <td className="py-3.5 px-4 font-semibold text-sm text-[var(--color-text-heading)]">
                    ...
                    <td className="py-3.5 px-4">
                      <div className="flex items-center gap-2">
                        <span
                          className={`font-semibold text-sm px-2.5 py-0.5 rounded-[var(--radius-control)] border font-mono ${
                            p.isLowStock
                              ? "bg-[var(--color-danger-light)] text-[var(--color-danger)] border-[var(--color-danger-border)] animate-pulse"
                        ...
                        {p.isLowStock && (
                          <span className="text-[var(--text-2xs)] text-[var(--color-danger)] font-bold">Repor!</span>
                        )}
                      </div>
                      <span className="text-[var(--text-2xs)] text-[var(--color-text-subtle)] block mt-0.5">
                    ...
                    <td className="py-3.5 px-4 text-right space-x-1.5">
                      <button
                        ...
                        className="px-2.5 py-1 bg-[var(--color-success-light)] hover:bg-[var(--color-success-light)] text-[var(--color-success)] font-bold rounded-[var(--radius-control)] transition-colors cursor-pointer text-[var(--text-2xs)]"
                      ...
                      <button
                        ...
                        className="px-2.5 py-1 bg-[var(--color-warning-light)] hover:bg-[var(--color-warning-light)] text-[var(--color-warning)] font-bold rounded-[var(--radius-control)] transition-colors cursor-pointer text-[var(--text-2xs)]"
                      ...
                      <button
                        ...
                        className="p-1.5 text-[var(--color-text-subtle)] hover:text-[var(--color-primary)] rounded-[var(--radius-control)] hover:bg-[var(--color-bg-muted)] transition-colors cursor-pointer"
                      ...
                      <button
                        ...
                        className="p-1.5 text-[var(--color-text-subtle)] hover:text-[var(--color-danger)] rounded-[var(--radius-control)] hover:bg-[var(--color-danger-light)] transition-colors cursor-pointer"
              ...
              {!editingProduct && (
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[var(--color-bg-subtle)] border border-[var(--color-border)] rounded-[var(--radius-control)] px-3.5 py-2.5 text-xs text-[var(--color-text-heading)] focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)] font-mono"
                  />
                </div>
              )}
      ...
      {isStockModalOpen && stockProduct && (
        ...
        >
          <form onSubmit={handleSaveStockAdjustment} className="space-y-4 text-xs">
            <div className="p-3 bg-[var(--color-bg-subtle)] rounded-[var(--radius-control)] border border-[var(--color-border)] flex items-center justify-between">
              <span className="text-[var(--color-text-muted)]">Estoque Atual:</span>
              <strong className="text-sm font-semibold text-[var(--color-text-heading)] font-mono">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <select
                  ...
                  className="w-full bg-[var(--color-bg-subtle)] border border-[var(--color-border)] rounded-[var(--radius-control)] px-3 py-2 text-xs text-[var(--color-text-heading)] focus:outline-none cursor-pointer font-bold"
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[var(--color-bg-subtle)] border border-[var(--color-border)] rounded-[var(--radius-control)] px-3 py-2 text-sm font-semibold text-[var(--color-text-heading)] focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)] font-mono"
                />
              </div>
            </div>
