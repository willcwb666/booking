...
export function ArrowRightLeft(props: IconProps) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <polyline points="20 17 24 13 20 9" />
      <line x1="4" y1="13" x2="24" y2="13" />
      <polyline points="4 7 0 11 4 15" />
      <line x1="20" y1="11" x2="0" y2="11" />
    </svg>
  );
}
...
export function Palette(props: IconProps) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.92 0 1.7-.72 1.7-1.65 0-.43-.16-.83-.44-1.14-.26-.29-.41-.66-.41-1.06 0-.93.75-1.68 1.68-1.68H16c3.31 0 6-2.69 6-6 0-4.97-4.48-9-10-9Z" />
    </svg>
  );
}
...
export function Dog(props: IconProps) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M10 5.172a2 2 0 0 0-1.414.586l-3 3A2 2 0 0 0 5 10.172V15a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-4.828a2 2 0 0 0-.586-1.414l-3-3A2 2 0 0 0 14 5.172V3a1 1 0 0 0-1-1h-2a1 1 0 0 0-1 1v2.172z" />
      <path d="M12 14v-2" />
    </svg>
  );
}

export function Shower(props: IconProps) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function Utensils(props: IconProps) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M18 2v20" />
      <path d="M21 2v6a3 3 0 0 1-3 3v11" />
...
export function Hammer(props: IconProps) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="m15 12-8.373 8.373a1 1 0 0 1-1.414 0l-1.586-1.586a1 1 0 0 1 0-1.414L12 9" />
      <path d="m18 15 4-4" />
      <path d="M21.5 11.5l-1.914-1.914A2 2 0 0 1 19 8.172V7l-2.293-2.293a1 1 0 0 0-.707-.293H14.5l-3 3v1.5a2 2 0 0 1-.586 1.414L9 12" />
    </svg>
  );
}
...
export function Hanger(props: IconProps) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M12 6a3 3 0 0 1 3 3c0 1.5-1 2.5-3 3-2-.5-3-1.5-3-3a3 3 0 0 1 3-3z" />
      <path d="M2 19 10.6 13.4a2 2 0 0 1 2.8 0L22 19a1 1 0 0 1-.6 1.7H2.6A1 1 0 0 1 2 19z" />
    </svg>
  );
}
...
export function Pizza(props: IconProps) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="m15 11-1 1" />
      <path d="M4 14 2 3l11 2" />
      <path d="M2 3c7.5 4.5 15.5 4.5 20 0l-4.5 17.5a2 2 0 0 1-3.2 1.1L2 3z" />
    </svg>
  );
}
...
export function PartyPopper(props: IconProps) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M9 3.51a1 1 0 0 1 1 0l3 3a1 1 0 0 1 0 1l-3 3a1 1 0 0 1-1 0l-3-3a1 1 0 0 1 0-1l3-3z" />
    </svg>
  );
}
...
export function Brush(props: IconProps) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M7.07 14.94c-1.66 0-3 1.35-3 3.02 0 1.33-2.5 1.52-2.5 2.04 0 .5 1.5 1 3 1 3.5 0 5.5-2 5.5-3.5 0-1.47-1.34-2.56-3-2.56Z" />
    </svg>
  );
}
...
export function Truck(props: IconProps) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M15 18h2a1 1 0 0 0 1-1v-4.586a1 1 0 0 0-.293-.707l-2.414-2.414A1 1 0 0 0 14.586 9H14" />
...
export function Bike(props: IconProps) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M12 17.5V14l-3-3 4-3 2.3 2.3" />
      <path d="M9 11l-4 4" />
    </svg>
  );
}
...
export function Feather(props: IconProps) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M12.67 19a2 2 0 0 0 1.416-.588l6.154-6.172a6 6 0 0 0-8.49-8.49L5.586 9.914A2 2 0 0 0 5 11.328V18a1 1 0 0 0 1 1h6.67z" />
      <path d="M16 8 2 22" />
      <path d="M17.5 15H9" />
    </svg>
  );
...
export function Refrigerator(props: IconProps) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <rect width="12" height="20" x="6" y="2" rx="2" />
      <line x1="6" x2="18" y1="10" y2="10" />
      <line x1="10" x2="10" y1="6" y2="8" />
      <line x1="10" x2="10" y1="14" y2="16" />
    </svg>
  );
}
...
export function Stove(props: IconProps) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function Microwave(props: IconProps) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <rect width="10" height="9" x="5" y="7" rx="1" />
...
export function Fan(props: IconProps) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M10.827 16.379a3 3 0 1 1-1.449-3.254" />
      <path d="M13.173 7.621a3 3 0 1 1 1.449 3.254" />
      <path d="M16.379 13.173a3 3 0 1 1-3.254 1.449" />
      <path d="M7.621 10.827a3 3 0 1 1 3.254-1.449" />
      <circle cx="12" cy="12" r="2" />
    </svg>
  );
}
...
export function Bug(props: IconProps) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M6 13H2" />
      <path d="M3 21c0-2.1 1.6-3.8 3.53-4" />
      <path d="M17.47 9c1.93-.2 3.53-1.9 3.53-4" />
      <path d="M18 13h4" />
      <path d="M21 21c0-2.1-1.6-3.8-3.53-4" />
    </svg>
  );
}
